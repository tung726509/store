...
class OrderController extends Controller
{
    ...
    public function getEdit(Request $request,$id)
    {
        ...
        if($order){
            ...
            return view('admin.order.edit',compact('now','products','order','warehouses','warehouse_main','use_birth_discount','use_free_ship','m_o_b','arr_ois_origin','ubd','ufs','order_items'));
        }else{
