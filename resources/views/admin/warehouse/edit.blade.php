...
<div class="row">
   <div class="col-12 col-md-8">
      	...
      	<div class="card animate__animated animate__rollIn animate__faster">
      		<div class="card-body">
	      		<h4 class="header-title">CHỈNH SỬA KHO HÀNG</h4>
	      		<p class="sub-header">
				   	...
				   	<div class="form-row">
				      	<div class="form-group col-md-6">
				         	...
				         	<div class="input-group">
				         		<input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Nhập tên kho hàng" value="{{old('name',$warehouse->name)}}" required>
				         	</div>
				         	@error('name')
				      	...
				      	<div class="form-group col-md-6">
				         	...
				         	<input type="text" class="form-control @error('address') is-invalid @enderror" id="address" name="address" placeholder="Nhập địa chỉ" value="{{old('address',$warehouse->address)}}">
				         	@error('address')
								<div class="text-small text-danger"><strong>{{ $message }}</strong></div>
	                    	@enderror
				      	</div>
