						   	...
						   	<div class="form-row">
						      	<div class="form-group col-md-12">
						         	...
						         	<div class="input-group">
						         		<input type="text" class="form-control @error('code') is-invalid @enderror" id="code" name="code" placeholder="Bấm nút tạo mã -->>" value="{{old('code')}}" required readonly>
						      	...
						      	<div class="form-group col-md-12">
						         	...
						         	<input type="text" class="form-control @error('pretty_name') is-invalid @enderror" id="pretty_name" name="pretty_name" placeholder="Nhập tên tag" value="{{old('pretty_name')}}" required>
						         	@error('pretty_name')
