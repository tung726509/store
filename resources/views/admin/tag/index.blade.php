...
@push('libs-styles')
<link href="{{asset('admini/css/rwd-table.min.css')}}" rel="stylesheet" type="text/css">
@endpush
                  ...
                  <form class="" id="filterForm" method="get" style="width: 100%">
                     <div class="col-sm-12 col-md-12 p-0">
                        ...
                        <div class="row mb-2">
                           ...
                           <div class="col-7">
                              <input type="search" name="s" id="s" class="form-control form-control-sm" placeholder="tên tag" aria-controls="datatable-buttons" value="{{$search}}">
                           </div>
                        </div>
                     </div>
                  </form>
               ...
               <div class="table-responsive mb-0" data-pattern="priority-columns">
                     ...
                     <thead>
                        <tr>
                           ...
                           <th data-priority="1" class="text-center">Thẻ tag</th>
                           ...
                           <td class="text-center">
                              <div class="btn-group">
                                  ...
                                  <div class="dropdown-menu" aria-labelledby="btnGroupDrop1" x-placement="bottom-start">
                                      ...
                                      <a class="dropdown-item" href="{{ route('administrator.tag.edit',['id'=>base64_encode($item->id)]) }}"><i class="far fa-edit icon-action" style="color: #F4FA58"></i> Chỉnh Sửa</a>
