...
<div class="row">
   	<div class="col-12 col-lg-10 offset-lg-1 col-xl-10 offset-xl-1">
          ...
          <div class="card-body">
        		<h4 class="header-title">THÊM MỚI DANH MỤC</h4>
                  ...
                  <div class="col-12 col-lg-10 offset-lg-1 col-xl-8 offset-xl-2">
                    <div class="owl-carousel owl-theme big-banner-owl">
                      <div class="item img-fg-t text-center">
                        <img class="img-bigbanner" src="{{ asset('homepage/images/big-banner-demo.jpg') }}" alt="placeholder+image" width="200px" height="200px">
                      </div>
                    </div>
                  </div>
                </div> --}}
