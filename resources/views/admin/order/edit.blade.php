  ...
  <div class="col-md-12 col-sm-12 col-12 p-0">
    ...
    <div class="card pl-1 pr-1 pt-3 pb-3 animate__animated animate__rollIn animate__faster">
        <h4 class="header-title">
          ...
          <a href="{{route('administrator.order.detail',['id'=>base64_encode($order->id)])}}"><span class="text-info pl-2 pt-1 hoverine">#{{$order->code}}</span></a>
        ...
        <p class="sub-header">
            {{-- Danh mục là mục lớn trên website bánh hàng giúp người mua hàng tìm kiếm sản phẩm theo danh mục đó . --}}
        </p>
       ...
       <div class="modal-content">
          <div class="modal-header">
             <div class="">
                ...
                <p class="text-small text-muted mb-0">Địa Chỉ : {{$order->customer->address != null ? $order->customer->address : ''}}</p>
        ...
        .done(function(res) {
            if(res.success){
                if(res.message == 'have not products'){
                    ...
                    let option_html = '';
                    // res.wh_items.forEach(function(item,index){ 
