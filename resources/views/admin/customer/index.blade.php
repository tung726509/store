                    ...
                    <td class="text-center">
                      <div class="btn-group">
                        ...
                        <div class="dropdown-menu" aria-labelledby="btnGroupDrop1" x-placement="bottom-start">
                          <a class="dropdown-item" href="{{route('administrator.customer.detail',['id'=>base64_encode($item->id)])}}"><i class="fas fa-info text-info icon-action"></i> Chi Tiết</a>
                          <a class="dropdown-item" href="{{route('administrator.customer.edit',['id'=>base64_encode($item->id)])}}"><i class="far fa-edit icon-action" style="color: #F4FA58"></i>Chỉnh Sửa</a>
