        ...
        <div class="row">
          <div class="col-12 col-md-4 col-xl-3 mt-3 offset-xl-1">
            ...
            <div class="row">
              ...
              <div class="col-8">
                <a href="{{route('administrator.customer.edit',['id'=>base64_encode($customer->id)])}}"><span class="badge badge-success mb-1 p-1">{{$customer->name}}</span></a><br>
              </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        $code = $item->code;
                        @endphp
                        <a href="{{route('administrator.order.detail',['id'=>base64_encode($item->id)])}}">
                        @switch($item->status)
                          @case(1){{-- chưa xử lý --}}
