...
<div class="row">
 	<div class="col-md-12 col-sm-12 col-12">
      ...
      <div class="card-body">
    		<h4 class="header-title">CHỈNH SỬA KHÁCH HÀNG <a href="{{route('administrator.customer.detail',['id'=>base64_encode($customer->id)])}}"><span class="text-info">#{{ $customer->name }}</span></a></h4>
