	            	...
	            	@csrf
				   	<div class="form-row">
				      	...
				      	<div class="form-group col-md-6">
				         	...
				         	<textarea class="form-control" rows="5" id="user_manual" name="user_manual">{{ old('user_manual',($product->description != null ? $product->description->user_manual : '')) }}</textarea>
				      	</div>
				      	<div class="form-group col-md-6">
				         	<label for="preservation" class="col-form-label">Hướng dẫn bảo quản</label>
				         	<textarea class="form-control" rows="5" id="preservation" name="preservation">{{ old('preservation',($product->description != null ? $product->description->preservation : '')) }}</textarea>
				      	</div>
				      	<div class="form-group col-md-6">
				      		<label for="description" class="col-form-label">Mô tả </label>
	                        <textarea class="form-control" rows="5" id="description" name="description">{{ old('description',($product->description != null ? $product->description->description : '')) }}</textarea>
				      	</div>
				      	<div class="form-group col-md-6">
				         	<label for="note" class="col-form-label">Lưu ý </label>
				         	<textarea class="form-control" rows="5" id="note" name="note">{{ old('note',($product->description != null ? $product->description->note : '')) }}</textarea>
				      	</div>
				   	</div>
				   	<div class="form-group text-right mb-0">
