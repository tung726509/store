...
@push('libs-styles')
  <link href="{{asset('homepage/css/jquery.bootstrap-touchspin.min.css')}}" rel="stylesheet" type="text/css">
@endpush
  ...
  <style type="text/css">
    ...
    .brcr-icon-lr{
     ...
     .mycart{
        ...
        height: auto;
        border-radius: 8px;
        box-shadow: 0px 2px 5px 3px #c4c4c4;
     }
     .mycart-header{
                     ...
                     <div class="col-lg-12">
                        ...
                        <div class="mycart">
                          <div class="mycart-header">
                            <div class="">Có <span>4</span> sản phẩm trong giỏ hàng</div>
                          </div>
                              ...
                              <div class="row">
                                <div class="col-12">
                                  ...
                                  <div class="product-name">
                                    <div class="text-center">
                                      <a href="#" class="text-uppercase">cặp màu đen</a>
                                      <i class="fas fa-arrow-down icon-cancel"></i><span class="red">giảm 10%</span>
                                    </div>
                                  </div> 
                                  <div class="product-price">
                                    <div class="text-center">
                                      <div class="form-group">
                                          <label for="demo2" class="col-md-4 control-label">Example:</label>
                                          <input id="demo2" type="text" value="0" name="demo2" class="col-md-8 form-control">
                                      </div>
                                      <div class="">Giá: 2000000đ</div>
                                    </div>
                                  </div>
                                  <div class="">
                                    <div class="text-center">
...
@push('libs-scripts')
  <script src="{{ asset('homepage/js/jquery.bootstrap-touchspin.min.js') }}"></script>
@endpush
